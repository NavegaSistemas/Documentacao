...
| NVG_API_BACKOFFICE_NODEJS_BASE_URL_CLOUD | Base URL da **API Backoffice** no servidor Navega (cloud)                                                                   | `http://navegasrvapp.eastus.cloudapp.azure.com:8085` | api-navega-nodejs, web-navega-nodejs, agent-deployment-nodejs |
...
NVG_API_BACKOFFICE_NODEJS_BASE_URL_CLOUD=http://navegasrvapp.eastus.cloudapp.azure.com:8085
